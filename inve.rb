    ...
    case choice 
      when "1"
        ...
        while sold > count.to_i
          puts "You only have #{count} #{vehicle.capitalize}s please enter the correct number you sold:"
          sold = gets.chomp.to_i
        end
...
while true
  ...
  puts "2. Edit Existing Inventory"
  puts "3. Check Inventory"
  puts "Enter, 'Exit' to leave Inventory Management System\n"
  choice = gets.chomp
